...
export default function SocialMedia() {
  return (
    <>
      ...
      <div className="Gmail after:content-[''] rotate-90  hidden md:flex after:absolute after:bottom-0 after:rotate-90  after:left-[132%]  after:top-[-52px]  after:w-[1px] after:h-40 pb-8 dark:after:bg-white after:bg-black after:animate-pulse fixed bottom-60 -right-28  dark:text-white text-black text-sm p-4 z-50 rounded-full ">
